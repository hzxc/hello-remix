...
contract MdexPair is IMdexPair, MdexERC20 {
            ...
            if (_kLast != 0) {
                ...
                if (rootK > rootKLast) {
                    ...
                    uint256 denominator = rootK
                        .mul(IMdexFactory(factory).feeToRate())
                        .add(rootKLast);
        ...
        returns (uint256 amount0, uint256 amount1)
    {
        ...
        require(
            amount0 > 0 && amount1 > 0,
            "MdexSwap: INSUFFICIENT_LIQUIDITY_BURNED"
        );
    ...
    function swap(
        ...
        require(
            ...
            "MdexSwap: INSUFFICIENT_OUTPUT_AMOUNT"
        );
        (uint112 _reserve0, uint112 _reserve1, ) = getReserves();
        // gas savings
        require(
            amount0Out < _reserve0 && amount1Out < _reserve1,
            "MdexSwap: INSUFFICIENT_LIQUIDITY"
        );
        ...
        require(
            ...
            "MdexSwap: INSUFFICIENT_INPUT_AMOUNT"
        );
        {
...
contract MdexFactory is IMdexFactory {
    ...
    function setFeeToSetter(address _feeToSetter) external {
        ...
        require(
            ...
            "MdexSwapFactory: FeeToSetter is zero address"
        );
        feeToSetter = _feeToSetter;
    }
    ...
    function setInitCodeHash(bytes32 _initCodeHash) external {
        ...
        require(
            initCode == false,
            "MdexSwapFactory: Do not repeat settings initCodeHash"
        );
        ...
        returns (uint256 reserveA, uint256 reserveB)
    {
        ...
        (uint256 reserve0, uint256 reserve1, ) = IMdexPair(
    ...
    function quote(
        ...
        require(
            ...
            "MdexSwapFactory: INSUFFICIENT_LIQUIDITY"
        );
