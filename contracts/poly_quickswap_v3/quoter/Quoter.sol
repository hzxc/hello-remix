...
import "../algebra/libraries/SafeCast.sol";
import "../algebra/libraries/TickMath.sol";
import "../algebra/libraries/FullMath.sol";

import "../algebra/interfaces/IAlgebraPool.sol";
import "../algebra/interfaces/callback/IAlgebraSwapCallback.sol";
...
contract Quoter is IQuoter, IAlgebraSwapCallback, PeripheryImmutableState {
    ...
    function getPool(address tokenA, address tokenB)
        private
        view
        returns (IAlgebraPool)
    {
        return
            IAlgebraPool(
                PoolAddress.computeAddress(
                    poolDeployer,
                    PoolAddress.getPoolKey(tokenA, tokenB)
                )
            );
    }
